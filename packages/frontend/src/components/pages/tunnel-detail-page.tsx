        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 text-sm text-slate-400 mt-1">
              ...
              <span>→</span>
              <a
                href={`https://${tunnel.subdomain}.noverlink.dev`}
                target="_blank"
              ...
              <CopyButton text={`https://${tunnel.subdomain}.noverlink.dev`} />
            </div>
          </div>
        </div>
        <PulseBadge variant={isActive ? 'connected' : 'disconnected'} appearance="pill">
