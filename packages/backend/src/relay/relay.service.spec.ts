...
describe('RelayService', () => {
  ...
  describe('createSession', () => {
    ...
    it('should throw NotFoundException if domain not found', async () => {
      ...
      ).rejects.toThrow(new NotFoundException('Domain unknown-subdomain not found'));
    });
  ...
  describe('closeSession', () => {
    ...
    it('should throw NotFoundException if session not found', async () => {
      ...
      ).rejects.toThrow(new NotFoundException('Session unknown-session not found'));
    });
        ...
        requests: [
          {
            ...
            request_headers: Buffer.from('{"content-type":"application/json"}').toString('base64'),
            response_status: 200,
            duration_ms: 150,
