...
import { OAuthConnection, OAuthProvider, User, UserPlan } from '@noverlink/backend-shared';
...
describe('AuthService', () => {
  ...
  describe('validateOAuthLogin', () => {
    ...
    it('should create new user for new OAuth login', async () => {
      ...
      expect(em.create).toHaveBeenCalledWith(User, expect.objectContaining({
        email: 'new@example.com',
        emailVerified: true,
      }));
      expect(em.create).toHaveBeenCalledWith(OAuthConnection, expect.objectContaining({
  ...
  describe('Device Code Flow', () => {
    describe('startDeviceFlow', () => {
      it('should return device code response', () => {
        ...
        expect(result.verification_uri).toBe('https://app.noverlink.io/auth/device');
      });
    ...
    describe('approveDeviceCode', () => {
      ...
      it('should be case insensitive', async () => {
        ...
        const result = await service.approveDeviceCode(user_code.toLowerCase(), 'user-123');
