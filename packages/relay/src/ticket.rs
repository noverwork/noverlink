...
mod tests {
    ...
    fn test_valid_ticket() {
        ...
        let payload = TicketPayload {
            ...
            max_tunnels: 1,
            subdomain: None,
            base_domain: "noverlink.app".to_string(),
        ...
        assert_eq!(verified.base_domain, "noverlink.app");
    }
    ...
    fn test_sandbox_domain_ticket() {
        ...
        let payload = TicketPayload {
            ...
            max_tunnels: 1,
            subdomain: Some("happy-cat".to_string()),
            base_domain: "noverlink-free.app".to_string(),
            ticket_id: "ticket-004".to_string(),
            exp: now + 60,
            sig: None,
        };
        ...
        assert!(result.is_ok());
        let verified = result.unwrap();
        assert_eq!(verified.plan, "sandbox");
        assert_eq!(verified.base_domain, "noverlink-free.app");
        assert_eq!(verified.subdomain, Some("happy-cat".to_string()));
    }
}
